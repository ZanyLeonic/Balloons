 ...
 * For the Blue coloured balloon.
 * @author ZanyLeonic
 * @version 0.1
 * 
 */
public class BlockBalloonBlue extends BlockContainer {
	
	public BlockBalloonBlue() {
	...
	public TileEntity createNewTileEntity(World var1, int var2) {
		return new TileEntityBalloonBlockBlue();
	}
	
	@SideOnly(Side.CLIENT)
	public void registerBlockIcons(IIconRegister iconRegister){
		this.blockIcon = iconRegister.registerIcon(References.MODID + ":" + "balloon_blue");
	}
}
