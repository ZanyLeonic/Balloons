...
public class RenderBalloonGrey extends TileEntitySpecialRenderer {
	
	private static final ResourceLocation texture = new ResourceLocation(References.MODID + ":" + "textures/models/balloon_grey.png");
	
	private ModelBalloon model;
	
	public RenderBalloonGrey() {
