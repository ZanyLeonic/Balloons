 ...
 * Lime coloured Balloon
 * @author ZanyLeonic
 * @version 1.8-0.1
 * 
 */

public class RenderBalloonLime extends TileEntitySpecialRenderer {
	
	private static final ResourceLocation texture = new ResourceLocation(References.MODID + ":" + "textures/models/balloon_lime.png");
	
	private ModelBalloon model;
	
	public RenderBalloonLime() {
