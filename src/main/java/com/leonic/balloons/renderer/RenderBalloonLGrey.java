 ...
 * Light Grey coloured Balloon
 * @author ZanyLeonic
 * @version 0.1
 * 
 */

public class RenderBalloonLGrey extends TileEntitySpecialRenderer {
	
	private static final ResourceLocation texture = new ResourceLocation(References.MODID + ":" + "textures/models/balloon_lgrey.png");
	
	private ModelBalloon model;
	
	public RenderBalloonLGrey() {
