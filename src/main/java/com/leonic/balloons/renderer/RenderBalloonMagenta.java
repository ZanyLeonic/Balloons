 ...
 * Magenta coloured Balloon
 * @author ZanyLeonic
 * @version 0.1
 * 
 */

public class RenderBalloonMagenta extends TileEntitySpecialRenderer {
	
	private static final ResourceLocation texture = new ResourceLocation(References.MODID + ":" + "textures/models/balloon_magenta2.png");
	
	private ModelBalloon model;
	
	public RenderBalloonMagenta() {
