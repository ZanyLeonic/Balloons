 ...
 * Cyan coloured Balloon
 * @author ZanyLeonic
 * @version 1.8-0.1
 * 
 */

public class RenderBalloonCyan extends TileEntitySpecialRenderer {
	
	private static final ResourceLocation texture = new ResourceLocation(References.MODID + ":" + "textures/models/balloon_cyan.png");
	
	private ModelBalloon model;
	
	public RenderBalloonCyan() {
