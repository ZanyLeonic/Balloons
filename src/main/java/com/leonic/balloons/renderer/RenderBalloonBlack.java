 ...
 * Black coloured Balloon
 * @author ZanyLeonic
 * @version 1.8-0.1
 * 
 */

public class RenderBalloonBlack extends TileEntitySpecialRenderer {
	
	private static final ResourceLocation texture = new ResourceLocation(References.MODID + ":" + "textures/models/balloon_black.png");
	
	private ModelBalloon model;
	
	public RenderBalloonBlack() {
