 ...
 * Green coloured Balloon
 * @author ZanyLeonic
 * @version 1.8-0.1
 * 
 */

public class RenderBalloonGreen extends TileEntitySpecialRenderer {
	
	private static final ResourceLocation texture = new ResourceLocation(References.MODID + ":" + "textures/models/balloon_green.png");
	
	private ModelBalloon model;
	
	public RenderBalloonGreen() {
