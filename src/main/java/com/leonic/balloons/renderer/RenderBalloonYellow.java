...
public class RenderBalloonYellow extends TileEntitySpecialRenderer {
	
	private static final ResourceLocation texture = new ResourceLocation(References.MODID + ":" + "textures/models/balloon_yellow.png");
	
	private ModelBalloon model;
	
	public RenderBalloonYellow() {
