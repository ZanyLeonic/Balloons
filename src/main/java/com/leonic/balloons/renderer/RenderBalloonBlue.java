 ...
 * Blue coloured Balloon
 * @author ZanyLeonic
 * @version 1.8-0.1
 * 
 */

public class RenderBalloonBlue extends TileEntitySpecialRenderer {
	
	private static final ResourceLocation texture = new ResourceLocation(References.MODID + ":" + "textures/models/balloon_blue.png");
	
	private ModelBalloon model;
	
	public RenderBalloonBlue() {
