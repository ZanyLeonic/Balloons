 ...
 * Brown coloured Balloon
 * @author ZanyLeonic
 * @version 1.8-0.1
 * 
 */

public class RenderBalloonBrown extends TileEntitySpecialRenderer {
	
	private static final ResourceLocation texture = new ResourceLocation(References.MODID + ":" + "textures/models/balloon_brown.png");
	
	private ModelBalloon model;
	
	public RenderBalloonBrown() {
